...
const TableHeader = (props) => {
    ...
    return (
        ...
        backgroundColor: "white", width: "80px", border: "2px solid #EEEEEE",
        ...
        height: "90px"}}>
            ...
            fontWeight: "bolder"}}> Class Routine</p>
            <p style={{margin: "0px", fontSize: '16px',
            fontWeight: "500", color: "#B9B9B9"}}> {props.value}</p>
            <p style={{margin: "0px", fontSize: '16px',
            fontWeight: "500", color: "#B9B9B9"}}> 10 Courses</p>
